...
(function(window, document) {
  ...
  Headroom.prototype = {
     ...
     */
    getScrollY : function() {
      return (this.target.scrollY !== undefined)
    ...
    getViewportHeight : function () {
      return this.target.innerHeight
    ...
    getDocumentHeight : function () {
      var target = this.target === window ? document.body : this.target,
        documentElement = document.documentElement;
  
      return Math.max(
          target.scrollHeight, documentElement.scrollHeight,
          target.offsetHeight, documentElement.offsetHeight,
          target.clientHeight, documentElement.clientHeight
      );
    },
